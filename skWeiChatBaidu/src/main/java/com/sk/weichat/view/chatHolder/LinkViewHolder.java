...
class LinkViewHolder extends AChatHolderInterface {
    ...
    public void fillData(ChatMessage message) {
        ...
        AvatarHelper.getInstance().displayImage(appIcon, ivLinkInco);
        ...
        if (TextUtils.isEmpty(appIcon) && TextUtils.isEmpty(imageUrl)) {
            ...
            AvatarHelper.getInstance().displayImage(appIcon, ivLinkImage);
        } else {
            AvatarHelper.getInstance().displayImage(imageUrl, ivLinkImage);
        }
    }
