...
public class RoomMemberDao {
     ...
     * 添加一个群成员
     */
    public boolean saveSingleRoomMember(String roomId, RoomMember roomMember) {
        ...
        try {
            /*List<RoomMember> members = getRoomMember(roomId);
            for (RoomMember member : members) {
                if (member.getUserId().equals(roomMember.getUserId())) {
                    // 该表已存在该群成员
                    return false;
                }
            }*/
