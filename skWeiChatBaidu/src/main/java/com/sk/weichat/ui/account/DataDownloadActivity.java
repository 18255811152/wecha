...
public class DataDownloadActivity extends BaseActivity {
    ...
    private void doBack() {
        DialogHelper.showSingleTextDialog(this, InternationalizationHelper.getString("JX_Tip"), InternationalizationHelper.getString("UPDATE_YET"), new View.OnClickListener() {
            @Override
            public void onClick(View v) {
