...
public class RegisterUserBasicInfoActivity extends BaseActivity implements View.OnClickListener {
        ...
        if (requestCode == REQUEST_CODE_CAPTURE_CROP_PHOTO) {
            ...
            if (resultCode == Activity.RESULT_OK) {
                ...
                if (mNewPhotoUri != null) {
                    ...
                    AvatarHelper.getInstance().displayImage(mNewPhotoUri.toString(), mAvatarImg);
                } else {
    ...
    private void doBack() {
        DialogHelper.showSingleTextDialog(this, InternationalizationHelper.getString("JX_Tip"), getString(R.string.cancel_register_prompt), new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                finish();
            }
