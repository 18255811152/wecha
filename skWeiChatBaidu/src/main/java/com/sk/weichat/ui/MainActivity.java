...
import com.sk.weichat.view.BigSelectionFrame;
...
*/
    ...
    private void initBroadcast() {
        ...
        filter.addAction("SEND_MULTI_NOTIFY");  // 群发消息结束
...
//            } else {
                if (keyCode == KeyEvent.KEYCODE_BACK && event.getAction() == KeyEvent.ACTION_DOWN) {
                    ...
                    if (secondTime - currentBackPressedTime > BACK_PRESSED_INTERVAL) {
                        Toast.makeText(MainActivity.this, "再按一次退出程序", Toast.LENGTH_SHORT).show();
                        currentBackPressedTime = secondTime;
                        return true;
                    } else {
                        System.exit(0);
                    }
...
*/
                    ...
                    CountDownTimer mCountDownTimer = new CountDownTimer(6000, 1000) {
                        ...
                        public void onFinish() {
                            ...
                            if (user != null) {
                                ...
                                Log.e("zq", "本地用户数据空了");
                                Toast.makeText(MainActivity.this, "本地用户数据空了", Toast.LENGTH_SHORT).show();
                            }
                        }
                    };
    ...
    */
    ...
    private void checkNotifyStatus() {
        ...
        if (launchCount == 1) {
            ...
            if (!TextUtils.isEmpty(tip)) {
                ...
                bigSelectionFrame.setSomething(tip, new BigSelectionFrame.OnSelectionFrameClickListener() {
                    @Override
            ...
            case 888:
                if (resultCode == Activity.RESULT_OK) {
                    ...
                    if (result.length() == 20 && RegexUtils.checkDigit(result)) {
                        // 长度为20且 && 纯数字 认定为付款码 调用扫付款码接口
                        handlerScanPaymentCode(result);
                    } else {
    ...
    private void handlerScanPaymentCode(String paymentCode) {
        String money = String.valueOf(1);
    ...
    private void uploadAddressBook() {
        ...
        HttpUtils.get().url(coreManager.getConfig().ADDRESSBOOK_UPLOAD)
                .params(params)
                .build()
